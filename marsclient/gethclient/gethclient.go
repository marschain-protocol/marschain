...
//
// If you want to use the standardized Ethereum RPC functionality, use marsclient.Client instead.
type Client struct {
	c *rpc.Client
}
...
// the message call.
// Please use marsclient.CallContract instead if you don't need the override functionality.
