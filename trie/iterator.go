...
type NodeIterator interface {
	...
	AddResolver(marsdb.KeyValueReader)
}
...
type nodeIterator struct {
	...
	resolver marsdb.KeyValueReader // Optional intermediate resolver above the disk layer
}
...
func (it *nodeIterator) AddResolver(resolver marsdb.KeyValueReader) {
...
func (it *differenceIterator) AddResolver(resolver marsdb.KeyValueReader) {
...
func (it *unionIterator) AddResolver(resolver marsdb.KeyValueReader) {
	panic("not implemented")
}
