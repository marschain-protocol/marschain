...
type Database struct {
	diskdb marsdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb marsdb.KeyValueStore) *Database {
...
func NewDatabaseWithConfig(diskdb marsdb.KeyValueStore, config *Config) *Database {
...
func (db *Database) DiskDB() marsdb.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch marsdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
