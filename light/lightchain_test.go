...
func makeHeaderChain(parent *types.Header, n int, db marsdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (marsdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() marsdb.Database {
	return odr.db
}
