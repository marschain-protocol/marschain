...
func (p *Deimos) delayForRamanujanFork(snap *Snapshot, header *types.Header) time.Duration {
...
func (p *Deimos) blockTimeVerifyForRamanujanFork(snap *Snapshot, header, parent *types.Header) error {
	if p.chainConfig.IsRamanujan(header.Number) {
