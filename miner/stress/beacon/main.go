...
func makeFullNode(genesis *core.Genesis) (*node.Node, *mars.Ethereum, *ethcatalyst.ConsensusAPI, error) {
	...
	ethBackend, err := mars.New(stack, econfig)
	if err != nil {
		return nil, nil, nil, err
	}
