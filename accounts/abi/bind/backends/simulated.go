...
type SimulatedBackend struct {
	database   marsdb.Database  // In memory database to store our testing data
...
func NewSimulatedBackendWithDatabase(database marsdb.Database, alloc core.GenesisAlloc, gasLimit uint64) *SimulatedBackend {
...
func (fb *filterBackend) ChainDb() marsdb.Database { return fb.db }
