...
type accessTestFn func(db marsdb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db marsdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db marsdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db marsdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db marsdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
