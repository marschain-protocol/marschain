...
func loadAndParseJournal(db marsdb.KeyValueStore, base *diskLayer) (snapshot, journalGenerator, error) {
...
func loadSnapshot(diskdb marsdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, recovery, withoutTrie bool) (snapshot, bool, error) {
