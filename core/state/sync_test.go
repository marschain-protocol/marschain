...
// account array.
func checkStateAccounts(t *testing.T, db marsdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db marsdb.Database, root common.Hash) error {
...
func checkStateConsistency(db marsdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(marsdb.Database), srcRoot)
