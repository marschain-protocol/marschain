...
func NewTable(db marsdb.Database, prefix string) marsdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) ModifyAncients(fn func(marsdb.AncientWriteOp) error) (int64, error) {
	return t.db.ModifyAncients(fn)
}

func (t *table) ReadAncients(fn func(reader marsdb.AncientReader) error) (err error) {
...
func (t *table) NewIterator(prefix []byte, start []byte) marsdb.Iterator {
...
func (t *table) NewBatch() marsdb.Batch {
	return &tableBatch{t.db.NewBatch(), t.prefix}
}

func (t *table) DiffStore() marsdb.KeyValueStore {
	return nil
}

func (t *table) SetDiffStore(diff marsdb.KeyValueStore) {
	panic("not implement")
}

// NewBatchWithSize creates a write-only database batch with pre-allocated buffer.
func (t *table) NewBatchWithSize(size int) marsdb.Batch {
...
func (b *tableBatch) Replay(w marsdb.KeyValueWriter) error {
