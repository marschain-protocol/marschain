...
func SetupGenesisBlock(db marsdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	return SetupGenesisBlockWithOverride(db, genesis, nil, nil, nil)
}

func SetupGenesisBlockWithOverride(db marsdb.Database, genesis *Genesis, overrideBerlin, overrideArrowGlacier, overrideTerminalTotalDifficulty *big.Int) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) ToBlock(db marsdb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db marsdb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db marsdb.Database) *types.Block {
...
func GenesisBlockForTesting(db marsdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{
