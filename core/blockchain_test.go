...
import (
	...
	"github.com/ethereum/go-ethereum/mars/tracers/logger"
...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full, pipeline bool) (marsdb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (marsdb.Database, func()) {
