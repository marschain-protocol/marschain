...
func BlockchainCreator(t *testing.T, chaindbPath, AncientPath string, blockRemain uint64) (marsdb.Database, []*types.Block, []*types.Block, []types.Receipts, []*big.Int, uint64, *core.BlockChain) {
...
func startEthService(t *testing.T, genesis *core.Genesis, blocks []*types.Block, chaindbPath string) (*node.Node, *mars.Ethereum) {
	t.Helper()
