...
func showLeveldbStats(db marsdb.Stater) {
...
type snapshotIterator struct {
	init    bool
	account marsdb.Iterator
	storage marsdb.Iterator
}
...
var chainExporters = map[string]func(db marsdb.Database) utils.ChainDataIterator{
	"preimage": func(db marsdb.Database) utils.ChainDataIterator {
		iter := db.NewIterator(rawdb.PreimagePrefix, nil)
		return &preimageIterator{iter: iter}
	},
	"snapshot": func(db marsdb.Database) utils.ChainDataIterator {
