...
func ImportPreimages(db marsdb.Database, fn string) error {
...
// It's a part of the deprecated functionality, should be removed in the future.
func ExportPreimages(db marsdb.Database, fn string) error {
...
func ImportLDBData(db marsdb.Database, f string, startIndex int64, interrupt chan struct{}) error {
