...
// Status is the network packet for the status message for mars/64 and later.
...
// Read reads an mars packet from the connection.
...
// Write writes a mars packet to the connection.
