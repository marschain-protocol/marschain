...
import (
	...
	_ "github.com/ethereum/go-ethereum/mars/tracers/js"
	_ "github.com/ethereum/go-ethereum/mars/tracers/native"
)
...
var makeTest = function(tx, rewind) {
  ...
  var block   = mars.getBlock(mars.getTransaction(tx).blockHash);
  var genesis = mars.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.mars.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  mars.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
