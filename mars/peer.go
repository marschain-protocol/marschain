...
// ethPeerInfo represents a short summary of the `mars` sub-protocol metadata known
...
// ethPeer is a wrapper around mars.Peer to maintain a few extra metadata.
type ethPeer struct {
	*eth.Peer
	...
	syncDrop *time.Timer   // Connection dropper if `mars` sync progress isn't validated in time
	snapWait chan struct{} // Notification channel for snap connections
}

// info gathers and returns some `mars` protocol metadata known about a peer.
