...
// ethHandler implements the mars.Backend interface to handle the various network
...
// RunPeer is invoked when a peer joins on the `mars` protocol.
...
func (h *ethHandler) Handle(peer *eth.Peer, packet eth.Packet) error {
	...
	default:
		return fmt.Errorf("unexpected mars packet type: %T", packet)
	}
}
