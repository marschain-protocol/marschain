...
// Peer is a collection of relevant information we have about a `mars` peer.
type Peer struct {
...
// Version retrieves the peer's negoatiated `mars` protocol version.
...
// ReplyPooledTransactionsRLP is the mars/66 version of SendPooledTransactionsRLP.
...
// ReplyBlockHeaders is the mars/66 version of SendBlockHeaders.
...
// ReplyBlockBodiesRLP is the mars/66 version of SendBlockBodiesRLP.
...
// ReplyNodeData is the mars/66 response to GetNodeData.
...
// ReplyReceiptsRLP is the mars/66 response to GetReceipts.
