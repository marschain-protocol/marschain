...
// ProtocolVersions are the supported versions of the `mars` protocol (first
// is primary).
...
const (
	...
	// Protocol messages overloaded in mars/66
...
// Packet represents a p2p message in the `mars` protocol.
type Packet interface {
	Name() string // Name returns a string corresponding to the message type.
	Kind() byte   // Kind returns the message type.
}

// StatusPacket is the network packet for the status message for mars/64 and later.
...
// GetBlockHeadersPacket66 represents a block header query over mars/66
...
// BlockHeadersPacket represents a block header response over mars/66.
...
// GetBlockBodiesPacket represents a block body query over mars/66.
...
// BlockBodiesPacket is the network packet for block content distribution over mars/66.
...
// BlockBodiesRLPPacket66 is the BlockBodiesRLPPacket over mars/66
...
// GetNodeDataPacket represents a trie node data query over mars/66.
...
// NodeDataPacket is the network packet for trie node data distribution over mars/66.
...
// GetReceiptsPacket represents a block receipts query over mars/66.
...
// ReceiptsPacket is the network packet for block receipts distribution over mars/66.
...
// ReceiptsPacket66 is the mars-66 version of ReceiptsRLPPacket
...
// PooledTransactionsPacket is the network packet for transaction distribution over mars/66.
...
// PooledTransactionsRLPPacket66 is the mars/66 form of PooledTransactionsRLPPacket
