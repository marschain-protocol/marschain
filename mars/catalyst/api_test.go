...
func startEthService(t *testing.T, genesis *core.Genesis, blocks []*types.Block) (*node.Node, *mars.Ethereum) {
	t.Helper()
	...
	ethservice, err := mars.New(n, ethcfg)
	if err != nil {
		t.Fatal("can't create mars service:", err)
	}
